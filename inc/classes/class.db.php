...
class Db {
	...
	private $db_pass = "postgrespass";  // Change as required
	private $db_name = "renoveramej";	// Change as required
    ...
    private $lastInsertId = ""; // returning last insertid
    ...
    // Function for inserting emptyrow
