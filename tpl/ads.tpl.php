...
require($tpl_path . "searchnav.tpl.php");
                ...
                echo "</div>";
                echo "<div class='col-sm-8 col-xs-12'><ul class='info'><li><p><a href='?page=kat&cid=" . $cat_result['Cat_Id'] . "'><h4 class=''>" . $cat_result['Name'] . "</a>, <a href='?page=lan&sid=" . $state_result['State_Id'] . "'>"  . $state_result['Name'] . "</h4></a></p><p><a href='?page=ad&aid=" . $val['Ad_Id'] . "'><h3>" . $val['Title'] . "</h3></a></p></li>";
